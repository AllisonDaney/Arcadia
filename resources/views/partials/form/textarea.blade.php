...
<div @class(['flex flex-col', $class])>
    ...
    <textarea name="{{ $name }}" rows="4" placeholder="Votre message" maxlength="160" @class(['p-4 rounded-xl resize-none outline-asparagus-600', 'border border-red-500' => $hasError, $inputClass])></textarea>
