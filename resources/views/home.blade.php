        ...
        <div class="w-full flex items-center justify-center gap-16 mt-20 flex-wrap">
            @foreach ($homes as $home)
                <a href="{{ route('home_show', ['homeId' => $home['id']]) }}" class="group">
                    <img src="{{ asset(isset($home['homePictures'][0]) ? $home['homePictures'][0]['url'] : '/img/notfound.png') }}" class="w-60 rounded-xl mx-auto" alt="Image de {{ $home['name'] }} " onerror="this.src = '/img/notfound.png'">
